...
const REDES = [
  {
    nome: "Instagram",
    href: "https://instagram.com/meudivaonline",
    cor: "#E1306C",
  ...
  {
    nome: "YouTube",
    href: "https://youtube.com/@meudivaonline",
    cor: "#FF0000",
  ...
  {
    nome: "LinkedIn",
    href: "https://linkedin.com/company/meudivaonline",
    cor: "#0A66C2",
...
export function PublicFooter() {
  ...
  return (
    <footer style={{ backgroundColor: "#2F80D3", width: "100%", marginTop: "auto" }}>
      <div style={{ padding: "48px 32px 40px", display: "grid", gridTemplateColumns: "0.6fr 1.2fr 1fr 1fr 1fr 0.8fr", gap: "36px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div>
          ...
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "0.875rem", lineHeight: 1.7, margin: 0 }}>
            Seu espaço de cuidado, escuta e saúde mental.<br /><br />
            Conectamos você a terapeutas qualificados de forma simples, segura e acessível.
          </p>
          <p style={{ marginTop: "16px", fontSize: "0.875rem" }}>
            <a href="mailto:contato@meudivaonline.com" style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none" }}>contato@meudivaonline.com</a><br />
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              { label: "Como funciona", href: "/para-voce" },
              { label: "Encontrar terapeuta", href: "/busca" },
              { label: "Planos e preços", href: "/planos" },
              { label: "Sobre nós", href: "https://app.meudivaonline.com/sobre" },
              { label: "Privacidade", href: "/politica-privacidade" },
              { label: "Termos de uso", href: "/termos-uso" },
            ].map(link => (
              <li key={link.href}>
                <Link href={link.href} style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none", fontSize: "0.875rem" }}>{link.label}</Link>
              </li>
            ))}
          </ul>
        </div>
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              { label: "Como funciona", href: "/para-terapeutas" },
              { label: "Planos", href: "/para-terapeutas#planos" },
              { label: "Cadastrar-se", href: "/auth/register" },
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              { label: "Visão geral", href: "/para-empresas" },
              { label: "Cases de sucesso", href: "/cases" },
              { label: "Guia NR-1", href: "/nr1-guia" },
              { label: "Falar com especialista", href: "/para-empresas#falar-especialista" },
            ].map(link => (
              <li key={link.href}>
                <Link href={link.href} style={{ color: "rgba(255,255,255,0.8)", textDecoration: "none", fontSize: "0.875rem" }}>{link.label}</Link>
              </li>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
            {REDES.map(rede => (
              <a
                ...
                style={{ display: "flex", alignItems: "center", gap: "10px", color: "rgba(255,255,255,0.8)", textDecoration: "none", fontSize: "0.875rem" }}
              >
