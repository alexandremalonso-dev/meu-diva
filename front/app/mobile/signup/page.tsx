...
function MobileSignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(() => {
        // Especialista vai para login (assinatura é feita na web)
        // Paciente vai direto para o dashboard
    ...
    >
      ...
      <div className="flex-1 bg-white rounded-t-3xl -mt-4 px-6 pt-8 pb-10 overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {/* Tipo de conta — apenas Paciente e Especialista */}
          <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      Quero fazer sessões de terapia e cuidar da minha saúde
                      emocional
                    </p>
                  </div>
                  {formData.role === "patient" && (
                    <CheckCircle className="w-5 h-5 text-[#E03673] shrink-0" />
                  )}
                </div>
              </button>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      Quero atender pacientes online e fazer gestão da minha
                      carreira
                    </p>
                  </div>
                  {formData.role === "therapist" && (
          ...
          {/* Aviso para especialista — planos são gerenciados na web */}
          {formData.role === "therapist" && (
            <div className="p-3 bg-blue-50 border border-blue-200 rounded-xl">
              <p className="text-xs text-blue-700 text-center">
                A contratação de planos é feita pelo site{" "}
                <span className="font-semibold">meudivaonline.com</span> após o
                cadastro.
              </p>
            </div>
          )}
