...
import { Mail, User, Calendar, AlertCircle, ChevronRight, Users } from "lucide-react";
...
export function InvitesCard() {
  ...
  async function loadInvites() {
    try {
      ...
      console.log("📨 Convites do terapeuta:", data);
  ...
  // Mostra apenas os 3 primeiros convites no card
    ...
    return (
      <div className="bg-gradient-to-r from-[#E03673] to-[#E03673]/80 rounded-xl shadow-lg p-6">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h3 className="text-lg font-semibold text-white">Convites enviados</h3>
        </div>
  ...
  return (
    ...
    >
      ...
      <p className="text-white/80 text-sm mb-4">
        Acompanhe seus convites para pacientes
      </p>
            ...
            return (
              <div key={invite.id} className="bg-white/20 rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <p className="text-sm font-medium truncate text-white flex-1">
                    {patientName}
                  </p>
                </div>
