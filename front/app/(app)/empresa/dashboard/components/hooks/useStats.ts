// ===========================================
// HOOK PARA CÁLCULO DE ESTATÍSTICAS - EMPRESA
// Apenas sessões dos colaboradores da empresa
// ===========================================

import { useMemo } from 'react';
import type { Appointment, FilterPeriod, Stats, PeriodStats } from './types';

export function useEmpresaStats(appointments: Appointment[], totalAvailability: number = 0): Stats {
  return useMemo(() => {
    const now = new Date();
    ...
    // Calcular próximas sessões (futuras) - EMPRESA: apenas sessões dos colaboradores
    ...
    // Calcular slots ocupados (apenas sessões dos colaboradores)
    ...
    console.log("📊 [EMPRESA] useEmpresaStats calculado:", {
      totalAvailability,
      occupiedSlots,
      availableSlots,
      upcoming,
