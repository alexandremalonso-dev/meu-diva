...
config.hosts = {};
config.hosts.domain = 'meet.meudivaonline.com';
...
config.hosts.muc = 'muc.' + subdomain + 'meet.meudivaonline.com';
config.bosh = 'https://meet.meudivaonline.com/' + subdir + 'http-bind';
config.websocket = 'wss://meet.meudivaonline.com/' + subdir + 'xmpp-websocket';
