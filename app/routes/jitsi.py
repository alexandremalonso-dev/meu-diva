...
=======
>>>>>>> parent of 9315e57 (feat: adicionadas novas dependências e correções no modelo Payment)
...
# ============================================
# GERAR LINK (SEM ALTERAÇÃO RELEVANTE)
# ============================================
...
async def register_participant_join(
    ...
    # 🔥 SEMPRE cria novo registro (não sobrescreve)
