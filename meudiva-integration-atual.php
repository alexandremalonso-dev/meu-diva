...
function meudiva_get_featured_therapists($limit = 6) {
    // 🔥 Cache busting — força buscar dados frescos sempre
    $api_url = MEUDIVA_API_URL . '/public/terapeutas?limit=' . $limit . '&_=' . time();
    ...
    <div id="meudiva-footer-grid">
        ...
        <div>
            ...
            <div class="meudiva-social-links">
                ...
                <a href="https://wa.me/5531984117772" target="_blank" rel="noopener" class="meudiva-social-link">
